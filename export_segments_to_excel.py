...
def export_data():
    ...
    try:
        # Fetch data using execution pattern
        ...
        # Export to Excel
        output_file = "ibs_2026_by_segment.xlsx"
        print(f"Writing {len(df)} records to {output_file}...")
        
        # Create a Pandas Excel writer using XlsxWriter as the engine.
        # Actually openpyxl is the default for xlsx in newer pandas, let's stick to default if possible or specify openpyxl
